...
<head>
    ...
    <script>
        mudarStatus = (id, status) => {
            window.location.href = '../controller/mudarStatusEvento.act.php?id=' + id + '&status=' + status;
        }
        editar = (id, status) => {
    ...
    <div class="container">
        <div class="admin-card">
            <div class="admin-card-header">
                ...
                <a href="adicionarEvento.php" class="admin-button outline">Adicionar Evento</a>
                ...
                <div class="admin-table-container">
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            $eventos = mysqli_query($con, "SELECT *, DATE_FORMAT(dataInicio, '%d/%m/%Y') as data_formatada FROM `evento` ");
                            ...
                            ?>
                                <tr>
                                    <td class="name-cell"><?= $evento['nome'] ?></td>
                                    <td><?= $evento['data_formatada'] ?></td>
                                    <td><?= $evento['pontoEncontro'] ?></td>
                                    ...
                                    <td class="actions-cell">
                                        <button class="admin-button small outline" onclick="editar(<?=$evento['idEvento']?>)">
