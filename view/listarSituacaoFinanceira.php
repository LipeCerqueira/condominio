...
<head>
    ...
    <script>
        ...
        editar = (id) => {
            window.location.href = '../view/editarSituacaoFinanceira.php?id=' + id;
        }
    </script>
</head>
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                <div class="admin-card-title">
                    ...
                    Administração de Situação Financeira
                </div>
                <a href="adicionarSituacaoFinanceira.php" class="admin-button outline">Adicionar Situação Financeira</a>
                ...
                <div class="admin-table-container">
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            $situacoes = mysqli_query($con, "SELECT * FROM `situacao_financeira` ");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $situacao['nome_situacao_financeira'] ?></td>


                                    <td>
                                        <?php
                                        if ($situacao['status_financeiro'] == '0') {
                                    ...
                                    <td class="actions-cell">
                                        <button class="admin-button small outline" onclick="editar(<?= $situacao['id_situacao_financeira'] ?>)">
                                        ...
                                        <?php
                                        $local = "financeira";
                                        if ($situacao['status_financeiro'] == '1') {
                                            echo '<button class="admin-button small destructive" onclick="mudarStatus(' 
        . $situacao['id_situacao_financeira'] . ', ' 
        . $situacao['status_financeiro'] . ', \'' 
        . $local . '\')">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="button-icon">
            <path d="M12 20h9"></path>
            <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
