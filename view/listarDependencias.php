...
<head>
    ...
    <script>
        ...
        editar = (id) => {
            window.location.href = '../view/editarDependencia.php?id=' + id;
        }
    </script>
</head>
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                <div class="admin-card-title">
                    ...
                    Administração de Dependências internas                </div>
                <a href="adicionarDependencia.php" class="admin-button outline">Adicionar Dependência</a>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="actions-cell">
                                        <button class="admin-button small outline" onclick="editar(<?= $area['id_area'] ?>)">
