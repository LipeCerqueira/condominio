...
<head>
    ...
    <script>
        mudarStatus = (id, status) => {
            window.location.href = '../controller/mudarStatus.act.php?id=' + id + '&status=' + status;
        }
        editar = (id, status) => {
            window.location.href = '../view/editarAdm.php?id=' + id;
        }
    </script>
</head>
                ...
                <div class="admin-table-container">
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            $usuarios = mysqli_query($con, "SELECT *, DATE_FORMAT(dataCadastro, '%d/%m/%Y %H:%i') AS data_formatada  FROM `usuario` where nivel < 5");
...
$i=1;
                            ...
                            ?>
                                <tr>
                                     <td class="num-user"><strong><?=$i .". " ?></strong></td>
